...
1) Dans le répertoire `superquiz`, remplacez le répertoire `src` par le répertoire `src` fourni dans EXO_STARTER.zip.
...
![Liste des quizzes](assets_exercices/quiz-question_screenshot.png)
